       ...
       <form action="addProduct" method="post" >
            ...
            <h1> Add New Product Form </h1>
               ...
               <!-- <label >Participant Id: </label>
                ...
                <input type="Date" name="expireDate" placeHolder="Stock" required>
           
                 <label >Select Product Category </label>
                  <select name="category" required>
                   <option value="">select-product-category-drop down</option>
                  ...
                  <select name="rackNo" required>
                   <option value="">select-Rack No-from-drop down</option>
                  ...
                  <select name="shellNo" required>
                   <option value="">select-Shell No-from-drop down</option>
                   <option value=1>1</option>
                   <option value=2>2</option>
                   <option value=3>3</option>
                   <option value=4>4</option>
